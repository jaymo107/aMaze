...
public class InstructionsButton extends Button {
    ...
    public void performAction() {
        ...
        try {
            ...
            InstructionScene instructionScene = new InstructionScene("Instructions", window);
            window.addScene(instructionScene);
            window.setScene(window.getArrayList().indexOf(instructionScene));
